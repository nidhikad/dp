...
def start_frontend():
    ...
    # Dev script uses `next dev --webpack` (see web/package.json) so Turbopack does not
    # traverse parent folders (e.g. ~/Downloads), which can fail with permission errors.
