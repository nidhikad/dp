...
const ALL_NAV_ITEMS: Record<string, { icon: LucideIcon; nameKey: string }> = {
  ...
  "/learn": { icon: BrainCircuit, nameKey: "Personalized Learning" },
...
export default function Sidebar() {
  ...
  const navGroups = useMemo(() => {
    const buildNavItems = (
      ...
      const orderedHrefs = [...hrefs];
      if (groupId === "learnResearch" && !orderedHrefs.includes("/learn")) {
        orderedHrefs.unshift("/learn");
      }
